use super::counter::BoardCounter;
...
pub const SHUFFLED_BOARD_STATS : BoardCounter = BoardCounter::from_counts(SHUFFLED_BOARD_COUNTS);
...
mod tests {
	...
	fn stats_constants_are_equal() {
		...
		assert_eq!(SHUFFLED_BOARD_TOTAL_MATCHES, SHUFFLED_BOARD_STATS.total_matches());
